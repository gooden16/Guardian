/*
  # Add admin policies for shifts table

  1. Changes
    - Add policies for administrators to manage shifts
    - Allow admins to create, update, and delete shifts
    - Keep existing policy for viewing shifts

  2. Security
    - Only administrators can manage shifts
    - All authenticated users can still view shifts
*/
